...
```hcl showLineNumbers title="layouts.hcl" {1-22}
...
```hcl showLineNumbers title="main.hcl" {1-12}
resource "lab" "main" {
...
> Content:
> - Chapter structure with instructional page
> - Step-by-step guide with context and troubleshooting
> - Clear learning objectives and explanations
> Tasks:
> - Interactive validation for file modification
> - Helpful error messages and hints
> - Integration with container infrastructure
> Scripts:
> - Robust validation logic with clear feedback
