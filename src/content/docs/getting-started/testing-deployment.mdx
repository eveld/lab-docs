...
> This lab teaches web server basics through hands-on nginx customization.
> Features:
> - Container-based nginx web server with network isolation
> - Interactive homepage customization activity  
> - Task validation with helpful feedback
> - Professional UI with service preview and terminal access
> - Comprehensive documentation and troubleshooting
> Learning Objectives:
> - Understand web server file structure
> - Practice direct file editing on servers
> - Learn relationship between files and live websites
> - Build confidence with command-line text editors
> Technical Implementation:
> - Resource chaining: network -> container -> service/terminal
> - HCL configuration following Instruqt best practices
> - Robust validation scripts with clear success/failure paths
> - User-friendly content organization
> Ready for deployment to Instruqt platform."
